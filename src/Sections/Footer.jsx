...
function Footer() {
  return (
    <footer className="flex w-[1440px] h-[421px] px-[80px] py-[64px] justify-center items-center shrink-0 border-0 border-solid border-[#E5E7EB] bg-[#111827]">
      <div className="w-full max-w-screen-xl flex flex-col gap-8">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-12 border-b border-gray-700 pb-8">
          ...
          <div className="max-w-md">
            {/* Logo */}
            <div className="flex items-center w-fit h-[47px] px-[3px] py-[9px] bg-black border border-black rounded">
              <svg
            ...
            {/* Description */}
            <p className="w-[418px] h-[72px] shrink-0 text-gray-400 text-[16px] font-normal leading-[24px] mt-4">
            ...
            <div className="flex items-center gap-4 mt-4">
              {["span.png", "Frame.png", "frame1.png"].map((src, index) => (
                <div
                  key={index}
                  className="flex w-[40px] h-[40px] px-3 py-2 justify-center items-center shrink-0 rounded-full border-0 border-solid border-[#E5E7EB] bg-gray-800"
                >
                  <img
                    src={src}
                    alt={`icon-${index}`}
          ...
          {/* Product Links */}
          <div className="flex w-[280px] pb-[28px] flex-col items-start gap-[16px] shrink-0 border-0 border-solid border-[#E5E7EB] bg-transparent">
